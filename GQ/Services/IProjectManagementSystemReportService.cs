...
namespace GQ
{
    public interface IProjectManagementSystemProjectReportPlanItemsService
    {
        ...
        Task<IEnumerable<PostProjectManagementSystemProjectReportFileDownload>> PostProjectManagementSystemProjectReportFileDownloadAsync(string fileTypeId, string tblIdID);
        ...
        Task<IEnumerable<PostProjectManagementSystemProjectReportSetWinner>> PostProjectManagementSystemProjectReportSetWinnerByParamsAsync(string pmsPppId, string budProjectId, string nationoanlCode, string trackingCode, string budPepRegisterDate, string aCCFinancialYearId, string tblUserId);
